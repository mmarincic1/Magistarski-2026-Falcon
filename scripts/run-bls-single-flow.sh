...
echo "=== Original BLS single credential flow ==="
echo

echo "[0/7] Cleaning previous BLS single run files..."
rm -f \
...
echo "[1/7] Generating BLS issuer key..."
...
echo "[5/7] Verifying BLS selective disclosure..."
...
echo
echo "✅ Original BLS single credential flow completed successfully."